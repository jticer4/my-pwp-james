...
<html>
	...
	<body>
		...
		<div class="container-fluid text-center">
			...
			<p class="pb-3"><a href="https://jticer4.github.io/react-movie-finder/" target="_blank"><img id="reactMovieFinderScreenshot" src="react-movie-finder-screenshot.png" alt="screenshot of react movie finder"></a><br><strong>React Movie Finder</strong><br>React Movie Finder is designed to allow users to search through the MoviesDB database using the React js library as the user interface.</p>
