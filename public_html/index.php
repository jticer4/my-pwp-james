...
<html>
	...
	<body>
		...
		<div class="container-fluid text-center">
			...
			<p class="pb-3"><a href="https://jticer4.github.io/react-calculator/" target="_blank"><img id="reactCalculatorScreenshot" src="react-calculator-screenshot.png" alt="screenshot of react js calculator"></a><br><strong>React.JS Calculator</strong><br>A simple calculator built using React JS and styled using Bootstrap and CSS</p>
